...
<html>
    ...
    <body>
	            			...
	            			<div class="d-flex align-items-center justify-content-center">
	            				<c:choose>
	            					<c:when test="${game.gsale != 1 }">
			            				<p class="game_price_big mx-3">\ ${String(game.gprice / 100 * (100 - game.gsale)).replace(".0", "")}</p>
        ...
        <c:if test="${sessionScope.loginId != null && ocode != null}">
		        ...
		        <div class="reviewDiv my-3 p-4 pb-0">
		        	<c:forEach items="${reviewList }" var="review">
			            ...
			            <div class="row my-3">
			            	...
			            	<div class="d-flex justify-content-center">
			            		<button class="likeButton mx-3" onclick="reLike(this, '${sessionScope.loginId}', '${review.RCODE}', 'good')">좋아요</button>
			            		<button class="likeButton mx-3" onclick="reLike(this, '${sessionScope.loginId}', '${review.RCODE}', 'bad')">싫어요</button>
			            	</div>
    ...
    <script type="text/javascript">
    	function reLike(buttEl, memId, rcode, selected){
    		$.ajax({
    			type : "get",
    			...
    			success : function(re){
    				if(re == '3'){
    					...
    					buttEl.parentElement.previousElementSibling.querySelector('.likes').innerText = '추천수 : ' + re
    				}
    				console.log(re);
    			}
    		});
	    		...
	    		$.ajax({
	    			...
	    			success : function(re){
	    				if(re == '1'){
	    					...
	    					if(check == true){
	    						location.href = '/basketpage?memId='+memId;
	    					}
	    				}
	    				else if(re == '3'){
	    					alert('해당 게임이 이미 장바구니에 있습니다.');
	    				}
	    				else {
