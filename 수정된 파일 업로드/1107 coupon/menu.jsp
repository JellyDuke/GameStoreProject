            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-12">
                        <li class="nav-item"><a class="nav-link active" style="width: 50px;" aria-current="page" href="${pageContext.request.contextPath }/">상점</a></li>
                        <li class="nav-item"><a class="nav-link active" style="width: 84px;" href="${pageContext.request.contextPath }/serviceCenter">고객지원</a></li>
