												...
												<c:choose>
													<c:when test="${game.gsale != 1 }">
														<div class="d-flex my-2">
															...
															<p class="game_price_big d-flex justify-content-center align-items-center me-2 mb-0">\ ${String(game.gprice * game.gsale).replace(".0", "")}</p>
											...
											<div class="gamePrice">
												...
												<c:choose>
													...
													<c:otherwise>
														<div class="d-flex align-items-center justify-content-center">
															-\
															<p class="gameAllSale m-0">${String(game.gprice - game.gprice * game.gsale).replace(".0", "") }</p>
														</div>
													</c:otherwise>
												</c:choose>
											</div>
												...
												<c:choose>
													...
													<c:otherwise>
														<div
															class="d-flex align-items-center justify-content-center text-center">
															\
															<p class="saleTotalPrice m-0">${String(game.gprice * game.gsale).replace(".0", "")}</p>
														</div>
													</c:otherwise>
												</c:choose>
											</div>
				...
				<div class="payInfo_Div mx-3 p-2">
					...
					<div class="payInfo_body">
						<div class="d-flex justify-content-center p-2">
							<div class="d-flex justify-content-center w-50">총 상품 금액</div>
						...
						<div class="d-flex p-2">
							<div class="d-flex justify-content-center w-50">총 할인 금액</div>
							<div class="d-flex justify-content-center w-50">
								<div>-\</div>
						...
						<div class="d-flex p-2">
							<div class="d-flex justify-content-center w-50">총 쿠폰 할인</div>
