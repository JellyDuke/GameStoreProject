	            	...
	            	<div class="mt-3 comment_info">
	            		<div class="mt-3 comment_title d-flex justify-content-between">
							  ...
							  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
							    <li><a class="dropdown-item" href="#">신규 구매</a></li>
							    <li><a class="dropdown-item" href="#">최근 플레이</a></li>
							    <li><a class="dropdown-item" href="#">가나다순</a></li>
							    <li><a class="dropdown-item" href="#">발매일순</a></li>
							  </ul>
							</div> 	
            			</div>
	            		<div class="table_div w-100 h-100">
							<table class="w-100 h-100">											
								<tr>
									...
									<td class="table_ft"> <a class="btn btn_game" href="">평가</a> <a class="btn btn_game" style="background-color: #4C4C4C; color: white;" href="">시작</a> </td>
								</tr>	
								<tr>
									<th class="table_th">
										<img class="w-100 h-100" style="border-radius: 10px;" alt="" src="https://cdn.epnc.co.kr/news/photo/201911/92733_83711_2650.jpg">
