...
<body>
	...
	<!-- 내용 -->
	<section class="py-5">
		<div style="width: 200px; border: solid 1px black; margin-left: 310px; margin-top: 20px; margin-bottom: 0;">
			<a href="${pageContext.request.contextPath }/gameList?gameCount=20">게임 더보기</a>
		</div>
		<hr>
