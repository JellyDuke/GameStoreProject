                   	...
                   	<c:choose>
                        ...
                        <c:otherwise>
	                        <li class="nav-item dropdown" style="margin-left: 70px;">
	                            <a class="nav-link dropdown-toggle active" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img style="width: 30px; height: 30px;" src="${sessionScope.loginProfile }"> ${sessionScope.loginMnickname }</a>
