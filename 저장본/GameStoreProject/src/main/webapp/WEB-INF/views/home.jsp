...
<link
	href="${pageContext.request.contextPath }/resources/users/css/stylesCompany.css"
	rel="stylesheet" />
</head>
<body>
	<!-- 메뉴 -->
	...
	<section class="py-5">
		<div
			style="width: 200px; border: solid 1px black; margin-left: 310px; margin-top: 20px; margin-bottom: 0;">
			<h4>정렬</h4>
		</div>
		<hr>
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto"
										href="/gameDetail?gcode=${gl.gcode }">GAME VIEW</a>
								</div>
							</div>
						</div>
					</div>
