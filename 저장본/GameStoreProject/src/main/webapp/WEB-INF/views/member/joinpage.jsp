...
<html lang="en">
    ...
    <body>
		      ...
		      <form class="join" action="${pageContext.request.contextPath }/memberJoin" method="post" enctype="multipart/form-data"
		        ...
		        <div class="join__field">
		          <i class="join__icon fas fa-user"></i>
					...
					<select class="join__input form-control" name="inputId2" id="inputId2" >
		...
		const eamil = $('#inputId').val() + $('#inputId2').val(); // 이메일 주소값 얻어오기!
		...
		$('.mail-check-input').blur(function () {
			...
			if(inputCode === code){
				...
				$('#inputId2').attr('readonly',true);
				$('#inputId2').attr('onFocus', 'this.initialSelect = this.selectedIndex');
		        $('#inputId2').attr('onChange', 'this.selectedIndex = this.initialSelect');
			}else{
